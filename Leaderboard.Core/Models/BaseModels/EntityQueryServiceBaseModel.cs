...
{
	/// <summary>
	/// A base class for all models that get the total count of all entities and a collection of a certain amount of them to display them on pages. No added validation attributes.
	/// </summary>
