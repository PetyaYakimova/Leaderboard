...
namespace Leaderboard.Tests.UnitTests
{
	...
	public class ContestServiceTests : UnitTestsBase
	{
		...
		[Test]
		public void UnpinContestForUser_ShouldThrowExceptionIfContestDoesntExist()
		{
			Assert.That(async () => await contestService.UnpinContestForUser(Guid.NewGuid(), MainUser.Id),
				Throws.Exception.TypeOf<EntityNotFoundException>());
		}

		[Test]
		public void UnpinContestForUser_ShouldThrowExceptionIfUserDoesntExist()
		{
		...
		[Test]
		public void DeleteTeam_ShouldThrowExceptionIfTeamDoesntExist()
		{
			Assert.That(async () => await contestService.DeleteTeamAsync(Guid.NewGuid()),
				Throws.Exception.TypeOf<EntityNotFoundException>());
		}
	}
}
