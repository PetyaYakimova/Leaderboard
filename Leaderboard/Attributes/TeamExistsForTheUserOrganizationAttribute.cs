...
{
	public class TeamExistsForTheUserOrganizationAttribute : ActionFilterAttribute
	{
		public override void OnActionExecuting(ActionExecutingContext context)
		{
			...
			if (value != null)
			{
				...
				if (Guid.TryParse(value.ToString(), out id))
				{
					...
					if (contestService != null && contestService.TeamExistsForOrganizationsByIdAsync(id, organizationId).Result == false)
					{
						context.Result = new StatusCodeResult(StatusCodes.Status404NotFound);
					}
				}
